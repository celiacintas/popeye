...
class Scene(QtGui.QGraphicsScene):
    ...
    def buttonsForChecker(self, myButtonOk, myButtonEdit):
        """ """

        proxyBotonEdit = QtGui.QGraphicsProxyWidget()
        proxyBotonOk = QtGui.QGraphicsProxyWidget()
        proxyBotonEdit.setWidget(myButtonEdit)
        proxyBotonOk.setWidget(myButtonOk)
        proxyBotonOk.setPos(self.width() - 45, self.height())
        proxyBotonEdit.setPos(self.width() - 110, self.height())

        self.addItem(proxyBotonOk)
